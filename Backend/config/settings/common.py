...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {"sites": "osmchadjango.contrib.sites.migrations"}
...
STATIC_ROOT = env.str("DJANGO_STATIC_ROOT", default=str(ROOT_DIR.path("staticfiles")))
...
MEDIA_ROOT = env.str("DJANGO_MEDIA_ROOT", default=str(ROOT_DIR.path("media")))
...
OSM_VIZ_TOOL_LINK = env(
    "VIZ_TOOL_LINK", default="https://osmlab.github.io/changeset-map/#"
)
...
MAP_ROULETTE_API_URL = env(
    "MAP_ROULETTE_API_URL", default="https://maproulette.org/api/v2/"
)

# Define the URL to where the user will be redirected after the authentication
# in OSM website
OAUTH_REDIRECT_URI = env(
    "OAUTH_REDIRECT_URI", default="http://localhost:8000/oauth-landing.html"
)
